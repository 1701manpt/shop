                ...
                <div class="purchase">
                    ...
                    <div class="purchase-list">
                        <div class="purchase-item">
                            <div class="purchase-item-id">Đơn hàng 1</div>
                            <div class="purchase-item-image">
                                <img src="https://cf.shopee.vn/file/ee411c2bb49cae053fd3a0c054943386_tn" alt="">
                            </div>
                            <div class="purchase-item-amount">Tổng 16 sản phẩm khác nhau</div>
                            <div class="purchase-item-price">Tổng giá tiền 99999 đ</div>
                            <div class="purchase-item-detail">
                                <button>Xem chi tiết</button>
                            </div>
                            <div class="purchase-item-delete">
                                <button>Hủy</button>
                            </div>
                        </div>
                        <div class="purchase-item">
