...
<body>
    <div class="app">
        ...
        <div class="app-body role">
            ...
            <div class="main">
                <div class="main-item">
                    <div class="item-title">Quản lý quyền tài khoản</div>
                    ...
                    <div class="item-content">
                        <table class="js-table table --role">
                            <!-- <tr>
            ...
            <form class="modal js-create-form">
                ...
                <div class="modal-header">Thêm quyền</div>
            ...
            <form class="modal js-update-form">
                ...
                <div class="modal-header">Cập nhật thông tin quyền</div>
                <div class="modal-body">
